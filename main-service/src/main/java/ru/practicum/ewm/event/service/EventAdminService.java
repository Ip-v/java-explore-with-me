...
public interface EventAdminService {
     ...
     */
    List<EventFullOutDto> getAll(Integer[] users, String[] states, Integer[] categories, LocalDateTime rangeStart,
     ...
     */
    EventFullOutDto update(EventFullDto dto, Long eventId);
     ...
     */
    EventFullOutDto publish(Long eventId);

    /**
     * Отклонение события<br>
     * <i>Событие не должно быть опубликовано.</i>
     */
    EventFullOutDto reject(Long eventId);
}
